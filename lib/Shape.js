...
export class Shape {
    ...
    rectangle(x, y, w, h) {
        if (arguments.length > 4) {
            throw new TypeError(
                `rectangle takes 4 arguments you gave:${Array.from(arguments)}`
            );
        }
        if (Number.isFinite(x) === false) {
            throw new TypeError(
    ...
    /**
     * Draws an circle on the canvas.
     * @param {number} x - The x-coordinate of the circle's center.
     * @param {number} y - The y-coordinate of the circle's center.
     * @param {number} w - The width of the circle.
     * @param {number} h - The height of the circle. Defaults to the width if not specified.
     */
    circle(x, y, w, h = w) {
        if (arguments.length > 4) {
            throw new Error(
                `circle takes 4 arguments you gave:${Array.from(arguments)}`
            );
        }
        if (Number.isFinite(x) === false) {
            throw new TypeError(
    ...
    line(xStart, yStart, xEnd, yEnd) {
        if (arguments.length > 4) {
            throw new Error(
                `line takes 4 arguments you gave:${Array.from(arguments)}`
            );
        }
    ...
    arc(x, y, w, h, startAngle, endAngle) {
        if (arguments.length > 6) {
            throw new Error(
                `arc takes 6 arguments you gave:${Array.from(arguments)}`
            );
        }
        if (Number.isFinite(x) === false) {
            throw new TypeError(
...
Object.defineProperty(Shape.prototype, "circle", {
    value: Shape.prototype.circle,
    writable: false,
    configurable: false,
});
