export class Vector {
    ...
    /**
     * How much the given vector points in the same direction of this vector.
     * If the result is positive → the two vectors generally point in the same direction.
     * If the result is zero → the vectors are perpendicular (at 90° to each other).
     * If the result is negative → they generally point in opposite directions.
     * @param {Vector} vec
     * @returns {number}
     */
    dot(vec) {
