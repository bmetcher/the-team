...
export class Entity {
    ...
    set x(value) {
        ...
        if (this.movedByCamera) {
            this.position.x = value - this.#tad.camera.xOffset;
            return;
        }
        this.position.x = value;
        return;
    ...
    get x() {
        if (this.movedByCamera) {
            return this.position.x + this.#tad.camera.xOffset;
        }
        return this.position.x;
    }
    ...
    set y(value) {
        ...
        if (this.movedByCamera) {
            this.position.y = value - this.#tad.camera.yOffset;
    ...
    get y() {
        if (this.movedByCamera) {
            return this.position.y + this.#tad.camera.yOffset;
        }
        return this.position.y;
    }
