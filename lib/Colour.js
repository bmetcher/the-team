...
export class Colour {
    ...
    constructor(tad) {
        ...
        this.#cache = new Set();
        Object.freeze(this); //protect against accidental assignment;
    }
