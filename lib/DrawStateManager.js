...
export class DrawState {
     ...
     * @property {boolean} shapeMovedByCamera
     ...
     * @property {boolean} textMovedByCamera
     * @property {number} textRotation
     * @constructor
     */
    constructor(tad) {
        this.shapeColour = tad.shape.colour;
        this.shapeBorder = tad.shape.border;
        ...
        this.shapeRotation = tad.shape.rotation;

        this.textColour = tad.text.colour;
        ...
        this.textRotation = tad.text.rotation;
