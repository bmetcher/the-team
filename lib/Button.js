...
export class Button extends Entity {
    ...
    update() {
        ...
        // .down and friends should return false if the button has not been drawn
        // within the previous two frames.
        if ((this.#tad.frameCount - this.#lastFrameDrawn) >= 2) {
            this.#hovered = false;
            this.#released = false;
            this.#down = false;
            return;
        ...
        this.#hovered = Button.isInRect(
            mouse.x, mouse.y, this.x, this.y, this.w, this.h
        );
    ...
    draw() {
        ...
        if (this.hasAsset()) {
            if (this.hovered && !this.down) {
                this.asset.scale = 110;
            } else {
                this.asset.scale = 100;
            }
            this.drawAssets();
